...
class TerritoryIcons 
{
	...
	static string TerritoryConflict			= "ZenTerritories/images/NoBuild.paa";
	static string WithinTerritory			= "ZenTerritories/images/NoBuild.paa";
	static string DeSpawnWarning			= "ZenTerritories/images/Build.paa";
	static string BuildPartWarning			= "ZenTerritories/images/NoBuild.paa";
	static string DismantleWarning			= "ZenTerritories/images/NoBuild.paa";
	static string LowerFlagWarning			= "ZenTerritories/images/NoBuild.paa";
	static string TerritoryRequiredWarning	= "ZenTerritories/images/NoBuild.paa";
}
